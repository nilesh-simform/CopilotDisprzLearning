# Navigation Guidelines - CopilotDisprzLearning React Native Project
...
const linking = {
  prefixes: ['copilotdisprzlearning://', 'copilotdisprzlearning.page.link//', 'https://copilotdisprzlearning.page.link'],
...
export const generateDeepLink = (screen: string, params?: any): string => {
  const baseURL = 'https://CopilotDisprzLearning.page.link';
